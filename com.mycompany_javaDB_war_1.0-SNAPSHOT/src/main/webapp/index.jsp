            ...
            <table class="table table-sm table-hover">
                <thead style="background-color:#28A745">
                    <tr>
                        ...
                        <th scope="col"><font color="FFFFFF">Contraseña</font></th>
                    </tr>
                </thead>
                <%try {
                        ...
                        while (rs.next()) {
                %><tr><%
                                out.println("<th scope=row><font color=" + bla + ">" + rs.getInt("id_user") + "</font></th>");
                                out.println("<td><font color=" + bla + ">" + rs.getString("name") + "</font></td>");
                                out.println("<td><font color=" + bla + ">" + rs.getString("password") + "</font></td>");
                    %></tr><%
                        }%>
                <tr>
                    <td colspan="2"><h2><font color="3DFCB9">Usuarios</font></h2></td>
                    <td><h2><a class="btn btn-success btn-block" href="formularioUsuario.jsp">Agregar Usuarios</a></h2></td>
                </tr>
            </table>
            <%
                } catch (Exception e) {
